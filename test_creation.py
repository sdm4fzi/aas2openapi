...
property_1_data_specification = model.DataSpecificationIEC61360(
...
sm2_data_specification = model.DataSpecificationIEC61360(
    preferred_name=model.LangStringSet({"en": "class_name"}),
    value="Sm2ClassName",
)
...
aas_data_specification = model.DataSpecificationIEC61360(
    preferred_name=model.LangStringSet({"en": "class_name"}),
    value="AasClassName",
)
...
# with open("data.json", "w", encoding="utf-8") as json_file:
    # write_aas_json_file(json_file, obj_store)
...
save_model_list_with_schema(aas_list, "data_and_schema.json")
